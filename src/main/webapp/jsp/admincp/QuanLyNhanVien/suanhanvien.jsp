        ...
        <div id="page-wrapper">
            ...
            <f:form method="post" modelAttribute="edituser">
            	<div class="form-group">
                     <input class="form-control" type="hidden" name="idUsername" value="${UserById.idUsername}" placeholder="Nhập Id tài khoản" autocomplete="off"/>
                </div>
            	<div class="form-group">
                     <input class="form-control" type="hidden" name="username" value="${UserById.username}" placeholder="Nhập tên tài khoản" autocomplete="off"/>
                </div>
                <div class="form-group">
            		<label>Username*</label>
                     <input class="form-control" value="${UserById.username}" disabled="disabled" autocomplete="off" required/>
                </div>
                <div class="form-group">
            		<label>Họ tên*</label>
                     <input class="form-control" name="hoTen" placeholder="Nhập họ và tên" value="${UserById.hoTen}" autocomplete="off" required/>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
            		<label>Password*</label>
                     <input class="form-control" name="password" type="password" placeholder="Nhập mật khẩu cấp 1 mới" autocomplete="off" required/>
                </div>
                <div class="form-group">
            		<label>Password 2*</label>
                     <input class="form-control" name="password2" type="password" placeholder="Nhập mật khẩu cấp 2 mới" autocomplete="off" required/>
                </div>
                ...
                <div class="form-group">
            		...
            		<label>Số điện thoại 1*</label>
                     <input class="form-control" name="sdtUser1" placeholder="Nhập số điện thoại 1" value="0<c:out value = "${i1}" />" autocomplete="off" required/>
                </div>
                <div class="form-group">
            		<label>Số điện thoại 2</label>
                     <input class="form-control" name="sdtUser2" placeholder="Nhập số điện thoại 2" value="0<c:out value = "${i2}" />" autocomplete="off"/>
                </div>
                <div class="form-group">
            		<label>Email</label>
                     <input class="form-control" name="email" placeholder="Nhập Email" value="${UserById.email}" autocomplete="off"/>
                </div>
                <div class="form-group">
                     <label>Địa chỉ*</label><textarea class="form-control" rows="3" name="diaChi" placeholder="Nhập địa chỉ nhân viên" required>${UserById.diaChi}</textarea>
                </div>
                <div class="form-group">
                     <input class="form-control" type="hidden" name="thoiGianTao" placeholder="Nhập thời gian tạo user" value="<fmt:formatDate value="${UserById.thoiGianTao}" pattern="yyyy/MM/dd HH:mm:ss" />" autocomplete="off"/>
                </div>
