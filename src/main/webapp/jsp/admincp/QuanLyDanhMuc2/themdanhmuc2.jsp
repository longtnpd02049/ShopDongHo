...
<body>
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Thêm danh mục sản phẩm 2</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <f:form method="post" modelAttribute="addDanhmucsp2">
            	<div class="form-group">
            		<label>Tên danh mục sản phẩm 2*</label>
                     <input class="form-control" name="name" placeholder="Nhập tên danh mục sản phẩm 2" autocomplete="off" required/>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
	                ...
	                <input class="form-control" name="sortId" placeholder="Nhập thứ tự sắp xếp" value="" autocomplete="off" required/>
                </div>
