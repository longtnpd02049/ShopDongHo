        ...
        <div id="page-wrapper">
            ...
            <f:form method="post" enctype="multipart/form-data" modelAttribute="addgallery">
            	<div class="form-group" align="center">
            		<input class="form-control" type="hidden" name="chitietsp.idChiTietSp" value="${chitietsp.idChiTietSp}" autocomplete="off"/>
				</div>
                <div class="form-group" align="center">
					<label for="image">Chọn hình ảnh: </label>
                    <input class="form-control" type="file" name="files" multiple="multiple" accept="image/*" required/>
				</div>
                <div class="form-group" align="center">
