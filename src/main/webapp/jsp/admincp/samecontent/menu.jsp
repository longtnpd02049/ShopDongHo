	...
	<div class="navbar-default sidebar" role="navigation">
		<div class="sidebar-nav navbar-collapse">
			<ul class="nav" id="side-menu">
				...
				<li><a href="index"><i class="fa fa-dashboard fa-fw"></i>Thống kê</a></li>
				...
				<li><a href="quanlydathang"><i class="fa fa-edit fa-fw"></i>Quản lý đơn hàng</a></li>
				<c:if test="${role.equalsIgnoreCase('Administrator')}">
					<li><a href="quanlynhanvien"><i class="fa fa-edit fa-fw"></i>Quản lý Nhân viên</a></li>
				</c:if>
				<c:if test="${role.equalsIgnoreCase('Administrator')}">
					<li><a href="quanlydoanhthu"><i class="fa fa-edit fa-fw"></i>Quản lý doanh thu</a></li>
				</c:if>
			</ul>
		</div>
		<!-- /.sidebar-collapse -->
