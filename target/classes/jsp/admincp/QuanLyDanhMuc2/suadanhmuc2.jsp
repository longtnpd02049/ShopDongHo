            ...
            <f:form method="post" modelAttribute="editdanhmuc2">
            	...
            	<div class="form-group">
            		<label>Tên danh mục*</label>
                     <input class="form-control" type="text" name=name value="${DanhmucspByID2.name}" placeholder="Nhập tên danh mục" required/>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" type="text" name="sortId" value="${DanhmucspByID2.sortId}" placeholder="Nhập sortID" required/>
                </div>
