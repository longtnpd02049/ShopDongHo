        ...
        <div id="page-wrapper">
            ...
            <f:form method="post" modelAttribute="editcomment">
            	<div class="form-group">
                     <input class="form-control" type="hidden" value="${BinhLuanById.idBinhLuan}" name="idBinhLuan"/>
                </div>
                <div class="form-group">
                     <input class="form-control" type="hidden" value="${BinhLuanById.chitietsp.idChiTietSp}" name="chitietsp.idChiTietSp"/>
                </div>
                <div class="form-group">
                     <label>Họ tên</label><input class="form-control" value="${BinhLuanById.hoTen}" name="hoTen"/>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                     <label>Email</label><input class="form-control" name="email" value="${BinhLuanById.email}"/>
                </div>
                <div class="form-group">
                	 <c:set var = "phone" value = "${BinhLuanById.phone}" />
                	 <fmt:parseNumber var = "i" type="number" value="${phone}"></fmt:parseNumber>
                     <label>Phone</label><input class="form-control" name="phone" value="0<c:out value = "${i}" />"/>
                </div>
                <c:if test="${BinhLuanById.thoiGianXacNhan!=null}">
	                <div class="form-group">
	                      <input class="form-control" type="hidden" value="<fmt:formatDate value="${BinhLuanById.thoiGianXacNhan}" pattern="yyyy/MM/dd HH:mm:ss" />" name="thoiGianXacNhan"/>
	                </div>
                </c:if>
                
                <div class="form-group">
                     <label>Nội dung bình luận</label><textarea class="form-control" rows="3" name="noiDungBinhLuan">${BinhLuanById.noiDungBinhLuan}</textarea>
                </div>
                <div class="form-group">
                	<input class="form-control" type="hidden" name="thoiGianBinhLuan" value="<fmt:formatDate value="${BinhLuanById.thoiGianBinhLuan}" pattern="yyyy/MM/dd HH:mm:ss" />"/>
                </div>
                <div class="form-group">
