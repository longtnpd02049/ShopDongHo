    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <f:form method="post" enctype="multipart/form-data" modelAttribute="addsanpham">
                ...
                <div class="form-group">
            		<label>Giá*</label>
                    <input class="form-control" name="giaSp" placeholder="Nhập giá sản phẩm"/>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" name="soLuongSp" placeholder="Nhập số lượng sản phẩm trong kho"/>
                </div>
                <div class="form-group">
            		<label>Đặc điểm nổi bật*</label>
                    <textarea class="form-control" rows="3" name="dacDiemNoiBat" placeholder="Nhập đặc điểm nổi bật"></textarea>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
            		<label>Vỏ*</label>
                    <input class="form-control" name="vo" placeholder="Nhập vỏ"/>
                </div>
                <div class="form-group">
            		<label>Đường kính*</label>
                    <input class="form-control" name="duongKinh" placeholder="Nhập đường kính"/>
                </div>
                <div class="form-group">
            		<label>Độ dày*</label>
                    <input class="form-control" name="doDay" placeholder="Nhập độ dày"/>
                </div>
                <div class="form-group">
            		<label>Độ chịu nước*</label>
                    <input class="form-control" name="doChiuNuoc" placeholder="Nhập độ chịu nước"/>
                </div>
                <div class="form-group">
            		<label>Thời gian bảo hành*</label>
                    <input class="form-control" name="baoHanh" placeholder="Nhập thòi gian bảo hành"/>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" rows="3" name="moTaThem" placeholder="Nhập mô tả thêm"></textarea>
                </div>
