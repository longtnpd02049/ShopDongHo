            ...
            <f:form method="post" modelAttribute="adduser">
                ...
                <div class="form-group">
            		<label>Password*</label>
                     <input class="form-control" name="password" placeholder="Nhập mật khẩu cấp 1"/>
                </div>
                <div class="form-group">
            		<label>Password 2*</label>
                     <input class="form-control" name="password2" placeholder="Nhập mật khẩu cấp 2"/>
                </div>
                <div class="form-group">
            		<label>Họ tên</label>
                ...
                <div class="form-group">
            		<label>Số điện thoại 1*</label>
                     <input class="form-control" name="sdtUser1" placeholder="Nhập số điện thoại 1"/>
                </div>
                <div class="form-group">
            		<label>Số điện thoại 2</label>
                     <input class="form-control" name="sdtUser2" placeholder="Nhập số điện thoại 2"/>
                </div>
                <div class="form-group">
            		<label>Email</label>
                ...
                <div class="form-group">
                     <label>Địa chỉ</label><textarea class="form-control" rows="3" name="diaChi" placeholder="Nhập địa chỉ nhân viên"></textarea>
                </div>
                <div class="form-group">
                     <input class="form-control" type="hidden" name="status" value="ok"/>
                </div>
                <div class="form-group">
