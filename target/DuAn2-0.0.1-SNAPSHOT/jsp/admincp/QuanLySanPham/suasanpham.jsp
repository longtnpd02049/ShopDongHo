        ...
        <div id="page-wrapper">
            ...
            <f:form method="post" enctype="multipart/form-data" modelAttribute="editsanpham">
            	...
            	<div class="form-group">
                    ...
                    <input class="form-control" name="tenSp" placeholder="Nhập tên sản phẩm" value="${chitietsp.tenSp}"/>
                </div>
                <input class="form-control" type="hidden" name="image" placeholder="Nhập đường dẫn hình ảnh" value="${chitietsp.image}"/>
                <div class="form-group">
                ...
                <div class="form-group">
            		...
            		<label>Giá*</label>
                    <input class="form-control" name="giaSp" placeholder="Nhập giá sản phẩm" value="<c:out value = "${i}" />" type="number"/>
                </div>
                <div class="form-group">
                    <input class="form-control" type="hidden" name="soLuongDat" placeholder="Nhập số lượng đặt" value="1"/>
                </div>
                <div class="form-group">
            		<label>Số lượng trong kho*</label>
                    <input class="form-control" name="soLuongSp" placeholder="Nhập số lượng sản phẩm trong kho" value="${chitietsp.soLuongSp}" type="number"/>
                </div>
                <div class="form-group">
            		<label>Đặc điểm nổi bật*</label>
                    <textarea class="form-control" rows="3" name="dacDiemNoiBat" placeholder="Nhập đặc điểm nổi bật">${chitietsp.dacDiemNoiBat}</textarea>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
            		<label>Vỏ*</label>
                    <input class="form-control" name="vo" placeholder="Nhập vỏ" value="${chitietsp.vo}"/>
                </div>
                <div class="form-group">
            		<label>Đường kính*</label>
                    <input class="form-control" name="duongKinh" placeholder="Nhập đường kính" value="${chitietsp.duongKinh}"/>
                </div>
                <div class="form-group">
            		<label>Độ dày*</label>
                    <input class="form-control" name="doDay" placeholder="Nhập độ dày" value="${chitietsp.doDay }"/>
                </div>
                <div class="form-group">
            		<label>Độ chịu nước*</label>
                    <input class="form-control" name="doChiuNuoc" placeholder="Nhập độ chịu nước" value="${chitietsp.doChiuNuoc }"/>
                </div>
                <div class="form-group">
            		<label>Thời gian bảo hành*</label>
                    <input class="form-control" name="baoHanh" placeholder="Nhập thòi gian bảo hành" value="${chitietsp.baoHanh}"/>
                </div>
                <div class="form-group">
                    <input class="form-control" type="hidden" name="status" placeholder="Nhập status" value="ok"/>
                </div>
                <div class="form-group">
                ...
                <c:if test="${chitietsp.thoiGianTaoSp!=null}">
	                <div class="form-group">
	                      <input class="form-control" type="hidden" value="<fmt:formatDate value="${chitietsp.thoiGianTaoSp}" pattern="yyyy/MM/dd HH:mm:ss" />" name="thoiGianTaoSp"/>
	                </div>
                </c:if>
